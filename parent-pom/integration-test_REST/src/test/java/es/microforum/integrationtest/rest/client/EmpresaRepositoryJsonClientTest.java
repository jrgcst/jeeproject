...
public class EmpresaRepositoryJsonClientTest {
	...
	public void getTest() {
		try {
			...
			Resource<Empresa> resource = getEmpresa(new URI("http://localhost:8081/service-frontend-0.0.3/empresa/nifTEST1"));
	...
	public void postTest() throws RestClientException, URISyntaxException {
		...
		String url = "http://localhost:8081/service-frontend-0.0.3/empresa";
	...
	public void putTest() throws RestClientException, URISyntaxException {
		jdbcTemplate.execute("INSERT INTO empresa VALUES ('nifTEST1', 'nombreTEST1', 'direccionTEST1', '2014-02-26', '0')");
		String url = "http://localhost:8081/service-frontend-0.0.3/empresa/nifTEST1";
		String acceptHeaderValue = "application/json";
	...
	public void deleteTest() {
		try {
			...
			assertTrue(count == 1);
			restTemplate.delete("http://localhost:8081/service-frontend-0.0.3/empresa/nifTEST1");
		} catch (Exception e) {
			e.printStackTrace();
			fail();
		}
